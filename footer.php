<div class="footer footer1">
        ...
        <div class="row">
          <div class="col-md-4 col-md-offset-4">
            ...
            <h4 class="white">Sistem Informasi Geografis Berbasis WEB</h4>
          ...
          <h5 class="white">Copyright &copy; Mike Corporation</h5>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h4>SISTEM INFORMASI GEOGRAFIS BERBASIS WEB</h4>
        <p>Program ini dibuat oleh Michael dan Dalvin.</p>
